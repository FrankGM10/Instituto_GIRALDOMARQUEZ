...
namespace Instituto.Controllers
{
    public class ProfesoresController : Controller
    {
        ...
        public ProfesoresController(dbsenatiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Profesores != null ? 
                          ...
                          Problem("Entity set 'dbsenatiContext.Profesores'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'dbsenatiContext.Profesores'  is null.");
            }
            var profesore = await _context.Profesores.FindAsync(id);
            if (profesore != null)
            {
