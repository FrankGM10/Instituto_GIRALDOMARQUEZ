...
namespace Instituto.Controllers
{
    public class CursosController : Controller
    {
        ...
        public CursosController(dbsenatiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Cursos != null ? 
                          ...
                          Problem("Entity set 'dbsenatiContext.Cursos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'dbsenatiContext.Cursos'  is null.");
            }
            var curso = await _context.Cursos.FindAsync(id);
            if (curso != null)
            {
