...
{
    public partial class dbsenatiContext : DbContext
    {
        public dbsenatiContext()
        {
        }

        public dbsenatiContext(DbContextOptions<dbsenatiContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("server=senativii.database.windows.net; database=dbsenati; User ID=senati; Password=Frank123;");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Bloque>(entity =>
            {
                entity.HasKey(e => e.IdBloque)
                    .HasName("PK__Bloques__6B06394398D0D5C0");
            ...
            modelBuilder.Entity<Curso>(entity =>
            {
                entity.HasKey(e => e.IdCurso)
                    .HasName("PK__Cursos__DC72196FFD6374A8");
            ...
            modelBuilder.Entity<Estudiante>(entity =>
            {
                entity.HasKey(e => e.IdEstudiante)
                    .HasName("PK__Estudian__9B410A89F32F7E8B");
            ...
            modelBuilder.Entity<Matricula>(entity =>
            {
                entity.HasKey(e => e.IdMatricula)
                    .HasName("PK__Matricul__230086D765DB080D");
            ...
            modelBuilder.Entity<Profesore>(entity =>
            {
                entity.HasKey(e => e.IdProfesor)
                    .HasName("PK__Profesor__4D3751F609AB866F");
            ...
            modelBuilder.Entity<Programa>(entity =>
            {
                entity.HasKey(e => e.IdPrograma)
                    .HasName("PK__Programa__9DB8D163CB13D6F3");
